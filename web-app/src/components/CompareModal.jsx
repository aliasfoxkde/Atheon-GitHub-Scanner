...
export default function CompareModal({ ids = [], onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60" onClick={onClose}>
      <div
        className="bg-gray-800 rounded-lg border border-gray-700 w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col"
            ...
            <div className="space-y-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr>
                      <th className="text-left text-gray-400 font-medium px-3 py-2 w-32">Metric</th>
                      {reports.map((r) => (
                        <th key={r.id} className="text-left text-white font-semibold px-3 py-2 min-w-32 truncate">
                          {r.name}
                        </th>
                      ))}
                    </tr>
