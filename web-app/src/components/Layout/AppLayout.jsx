...
const AppLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      ...
      {/* Footer */}
      <footer
        className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border-t border-gray-200 dark:border-gray-700 mt-auto transition-colors duration-300"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-1 text-sm text-gray-400">
                <li>
                  <a
                    href="https://github.com/aliasfoxkde/Atheon-Scanner#readme"
                ...
                <li>
                  <a
                    href="https://github.com/aliasfoxkde/Atheon-Scanner"
                    className="hover:text-white"
                  >
                    GitHub
                  </a>
            ...
            <div>
              ...
              <ul className="mt-2 space-y-1 text-sm text-gray-400">
                <li>
                  <a
                    href="https://github.com/aliasfoxkde/Atheon-Scanner/issues"
                    className="hover:text-white"
                  >
                    Report Issues
                  </a>
                ...
                <li>
                  <a
                    href="https://github.com/aliasfoxkde/Atheon-Scanner/discussions"
                    className="hover:text-white"
                  >
                    Discussions
                  </a>
                ...
                <li>
                  <a href="https://github.com/HoraDomu/Atheon" className="hover:text-white">
                    Atheon Project
                  </a>
                </li>
              </ul>
